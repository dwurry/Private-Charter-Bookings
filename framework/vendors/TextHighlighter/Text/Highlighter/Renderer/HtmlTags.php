...
class Text_Highlighter_Renderer_HtmlTags extends Text_Highlighter_Renderer_Array{
	 ...
	 * @var array
	 */
	var $_hilite_tags = array('default'=>'','code'=>'','brackets'=>'b','comment'=>'i','mlcomment'=>'i','quotes'=>'','string'=>'i','identifier'=>'b','builtin'=>'b','reserved'=>'u','inlinedoc'=>'i','var'=>'b','url'=>'i','special'=>'','number'=>'','inlinetags'=>'');
	...
	function finalize(){
		...
		if($this->_numbers){
			/*
			 * additional whitespace for browsers that do not display empty list items correctly
			 */
