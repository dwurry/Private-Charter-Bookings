...
class Text_Highlighter_Renderer_Console extends Text_Highlighter_Renderer{
	 ...
	 */
	var $_colors = array();
	var $_defColors = array('default'=>"\033[0m",'inlinetags'=>"\033[31m",'brackets'=>"\033[36m",'quotes'=>"\033[34m",'inlinedoc'=>"\033[34m",'var'=>"\033[1m",'types'=>"\033[32m",'number'=>"\033[32m",'string'=>"\033[31m",'reserved'=>"\033[35m",'comment'=>"\033[33m",'mlcomment'=>"\033[33m");
