...
class Text_Highlighter_Renderer_BB extends Text_Highlighter_Renderer_Array{
	 ...
	 * @var array
	 */
	var $_bb_tags = array('color'=>'color','list'=>'list','list_item'=>'*','code'=>'code');
	 ...
	 * @var boolean
	 */
	var $_colors = array('default'=>'Black','code'=>'Gray','brackets'=>'Olive','comment'=>'Orange','mlcomment'=>'Orange','quotes'=>'Darkred','string'=>'Red','identifier'=>'Blue','builtin'=>'Teal','reserved'=>'Green','inlinedoc'=>'Blue','var'=>'Darkblue','url'=>'Blue','special'=>'Navy','number'=>'Maroon','inlinetags'=>'Blue');
