...
class HTMLPurifier_Printer_ConfigForm extends HTMLPurifier_Printer{
	 ...
	 *        max length before compressing a directive name, set to false to turn off
	 */
...
class HTMLPurifier_Printer_ConfigForm_NullDecorator extends HTMLPurifier_Printer{
	...
	public function render($ns, $directive, $value, $name, $config){
		...
		$ret .= $this->end('label');
		$attr = array('type'=>'checkbox','value'=>'1','class'=>'null-toggle','name'=>"$name" . "[Null_$ns.$directive]",'id'=>"$name:Null_$ns.$directive",'onclick'=>"toggleWriteability('$name:$ns.$directive',checked)")		// INLINE JAVASCRIPT!!!!
		;
