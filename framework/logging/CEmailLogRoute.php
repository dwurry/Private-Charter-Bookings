...
class CEmailLogRoute extends CLogRoute{
	...
	protected function processLogs($logs){
		...
		if($subject === null) $subject = Yii::t('yii', 'Application Log');
	...
	public function setEmails($value){
		if(is_array($value)) $this->_email = $value;
		else $this->_email = preg_split('/[\s,]+/', $value, -1, PREG_SPLIT_NO_EMPTY);
	}
	...
	public function setHeaders($value){
		if(is_array($value)) $this->_headers = $value;
		else $this->_headers = preg_split('/\r\n|\n/', $value, -1, PREG_SPLIT_NO_EMPTY);
	}
}