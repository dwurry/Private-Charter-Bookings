...
abstract class CDbMigration extends CComponent{
	...
	public function getDbConnection(){
		if($this->_db === null){
			...
			if(!$this->_db instanceof CDbConnection) throw new CException(Yii::t('yii', 'The "db" application component must be configured to be a CDbConnection object.'));
		}
		return $this->_db;
	}
	 ...
	 * @param string $columns
	 *        name of the column to utilise as primary key. If there are multiple columns, separate them with commas.
	 * @since 1.1.13
	 */
