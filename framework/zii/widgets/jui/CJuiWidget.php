...
abstract class CJuiWidget extends CWidget{
	...
	protected function resolvePackagePath(){
		if($this->scriptUrl === null || $this->themeUrl === null){
			...
			if($this->scriptUrl === null) $this->scriptUrl = $cs->getCoreScriptUrl() . '/jui/js';
			if($this->themeUrl === null) $this->themeUrl = $cs->getCoreScriptUrl() . '/jui/css';
		}
	}
	...
	protected function registerCoreScripts(){
		$cs = Yii::app()->getClientScript();
		if(is_string($this->cssFile)) $cs->registerCssFile($this->themeUrl . '/' . $this->theme . '/' . $this->cssFile);
		...
		if(is_string($this->scriptFile)) $this->registerScriptFile($this->scriptFile);
