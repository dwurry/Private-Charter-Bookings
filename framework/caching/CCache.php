...
abstract class CCache extends CApplicationComponent implements ICache, ArrayAccess{
	...
	public function set($id, $value, $expire = 0, $dependency = null){
		...
		if($dependency !== null && $this->serializer !== false) $dependency->evaluateDependency();
		
		if($this->serializer === null) $value = serialize(array($value,$dependency));
		elseif($this->serializer !== false) $value = call_user_func($this->serializer[0], array($value,$dependency));
