...
class CDbCacheDependency extends CCacheDependency{
	...
	protected function getDbConnection(){
		if($this->_db !== null) return $this->_db;
			...
			if(($this->_db = Yii::app()->getComponent($this->connectionID)) instanceof CDbConnection) return $this->_db;
			else throw new CException(Yii::t('yii', 'CDbCacheDependency.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.', array('{id}'=>$this->connectionID)));
		}
	}
}
