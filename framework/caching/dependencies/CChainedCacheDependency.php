...
class CChainedCacheDependency extends CComponent implements ICacheDependency{
	...
	public function __construct($dependencies = array()){
		if(!empty($dependencies)) $this->setDependencies($dependencies);
	}
	...
	public function getDependencies(){
		if($this->_dependencies === null) $this->_dependencies = new CTypedList('ICacheDependency');
	...
	public function setDependencies($values){
		...
		foreach($values as $value){
			if(is_array($value)) $value = Yii::createComponent($value);
