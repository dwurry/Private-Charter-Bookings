...
class CAttributeCollection extends CMap{
	...
	public function __get($name){
		if($this->contains($name)) return $this->itemAt($name);
	...
	public function __isset($name){
		if($this->contains($name)) return $this->itemAt($name) !== null;
	...
	public function itemAt($key){
		if($this->caseSensitive) return parent::itemAt($key);
		else return parent::itemAt(strtolower($key));
	}
	...
	public function add($key, $value){
		if($this->caseSensitive) parent::add($key, $value);
		else parent::add(strtolower($key), $value);
	}
	...
	public function remove($key){
		if($this->caseSensitive) return parent::remove($key);
		else return parent::remove(strtolower($key));
	}
	...
	public function contains($key){
		if($this->caseSensitive) return parent::contains($key);
		else return parent::contains(strtolower($key));
	}
