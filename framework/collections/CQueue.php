...
class CQueue extends CComponent implements IteratorAggregate, Countable{
	...
	public function copyFrom($data){
		...
		}elseif($data !== null) throw new CException(Yii::t('yii', 'Queue data must be an array or an object implementing Traversable.'));
	}
	...
	public function peek(){
		if($this->_c === 0) throw new CException(Yii::t('yii', 'The queue is empty.'));
		else return $this->_d[0];
	}
