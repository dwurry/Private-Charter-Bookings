...
class CStack extends CComponent implements IteratorAggregate, Countable{
	...
	public function copyFrom($data){
		...
		}elseif($data !== null) throw new CException(Yii::t('yii', 'Stack data must be an array or an object implementing Traversable.'));
	}
	...
	public function peek(){
		if($this->_c) return $this->_d[$this->_c - 1];
		else throw new CException(Yii::t('yii', 'The stack is empty.'));
	}
