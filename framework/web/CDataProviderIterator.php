...
class CDataProviderIterator extends CComponent implements Iterator, Countable{
	...
	public function __construct(CDataProvider $dataProvider, $pageSize = null){
		...
		if(($pagination = $this->_dataProvider->getPagination()) === false) $this->_dataProvider->setPagination($pagination = new CPagination());
		
		if($pageSize !== null) $pagination->setPageSize($pageSize);
	}
