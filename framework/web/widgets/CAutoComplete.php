...
class CAutoComplete extends CInputWidget{
	...
	public function registerClientScript(){
		...
		if($this->data !== null) $data = CJavaScript::encode($this->data);
		else{
	...
	protected function getClientOptions(){
		static $properties = array('minChars','delay','cacheLength','matchSubset','matchCase','matchContains','mustMatch','selectFirst','extraParams','multiple','multipleSeparator','width','autoFill','max','scroll','scrollHeight','inputClass','resultsClass','loadingClass');
		...
		foreach($functions as $func){
			if($this->$func !== null){
				if($this->$func instanceof CJavaScriptExpression) $options[$func] = $this->$func;
				else $options[$func] = new CJavaScriptExpression($this->$func);
			}
		}
