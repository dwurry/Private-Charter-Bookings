...
class CHtmlPurifier extends COutputProcessor{
	...
	public function purify($content){
		if(is_array($content)) $content = array_map(array($this,'purify'), $content);
		else $content = $this->getPurifier()->purify($content);
		return $content;
	}
	...
	protected function getPurifier(){
		if($this->_purifier !== null) return $this->_purifier;
