...
class CActiveDataProvider extends CDataProvider{
	...
	public function getCountCriteria(){
		if($this->_countCriteria === null) return $this->getCriteria();
	...
	public function getSort($className = 'CSort'){
		if(($sort = parent::getSort($className)) !== false) $sort->modelClass = $this->modelClass;
		return $sort;
	}
	...
	protected function calculateTotalItemCount(){
		$baseCriteria = $this->model->getDbCriteria(false);
		if($baseCriteria !== null) $baseCriteria = clone $baseCriteria;
