...
class CFormInputElement extends CFormElement{
	 ...
	 */
	public static $coreTypes = array('text'=>'activeTextField','hidden'=>'activeHiddenField','password'=>'activePasswordField','textarea'=>'activeTextArea','file'=>'activeFileField','radio'=>'activeRadioButton','checkbox'=>'activeCheckBox','listbox'=>'activeListBox','dropdownlist'=>'activeDropDownList','checkboxlist'=>'activeCheckBoxList','radiolist'=>'activeRadioButtonList','url'=>'activeUrlField','email'=>'activeEmailField','number'=>'activeNumberField','range'=>'activeRangeField','date'=>'activeDateField');
	...
	public function getRequired(){
		...
		else return $this->getParent()->getModel()->isAttributeRequired($this->name);
	}
	...
	public function getLabel(){
		...
		else return $this->getParent()->getModel()->getAttributeLabel($this->name);
	}
	...
	public function render(){
		...
		$output = array('{label}'=>$this->renderLabel(),'{input}'=>$this->renderInput(),'{hint}'=>$this->renderHint(),'{error}'=>!$this->getParent()->showErrors?'':$this->renderError());
	...
	public function renderInput(){
		if(isset(self::$coreTypes[$this->type])){
			...
			if(strpos($method, 'List') !== false) return CHtml::$method($this->getParent()->getModel(), $this->name, $this->items, $this->attributes);
			else return CHtml::$method($this->getParent()->getModel(), $this->name, $this->attributes);
		}else{
