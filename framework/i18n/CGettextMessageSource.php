...
class CGettextMessageSource extends CMessageSource{
	...
	protected function loadMessages($category, $language){
		...
		if($this->useMoFile) $messageFile .= self::MO_FILE_EXT;
		else $messageFile .= self::PO_FILE_EXT;
		...
		if(is_file($messageFile)){
			if($this->useMoFile) $file = new CGettextMoFile($this->useBigEndian);
			else $file = new CGettextPoFile();
