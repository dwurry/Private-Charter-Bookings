...
<div class="view">
	...
	<?php
	/*
	 * <b><?php echo CHtml::encode($data->getAttributeLabel('build_cert_ind')); ?>:</b> <?php echo CHtml::encode($data->build_cert_ind); ?> <br /> <b><?php echo CHtml::encode($data->getAttributeLabel('no_eng')); ?>:</b> <?php echo CHtml::encode($data->no_eng); ?> <br /> <b><?php echo CHtml::encode($data->getAttributeLabel('no_seats')); ?>:</b> <?php echo CHtml::encode($data->no_seats); ?> <br /> <b><?php echo CHtml::encode($data->getAttributeLabel('ac_weight')); ?>:</b> <?php echo CHtml::encode($data->ac_weight); ?> <br /> <b><?php echo CHtml::encode($data->getAttributeLabel('speed')); ?>:</b> <?php echo CHtml::encode($data->speed); ?> <br /> <b><?php echo CHtml::encode($data->getAttributeLabel('operator_aircraft_id')); ?>:</b> <?php echo CHtml::encode($data->operator_aircraft_id); ?> <br />
	 */
	?>
