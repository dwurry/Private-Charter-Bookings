...
abstract class Image_Driver{
	...
	public function execute($actions){
		foreach($actions as $func=>$args){
			if(!$this->$func($args)) return FALSE;
		}
	 ...
	 * width and height.
	 * Valid properties are: width, height, top, left.
	 *
	 * @param
	...
	/**
	 * Return the current width and height of the temporary image.
	 * This is mainly
	...
	/**
	 * Resize an image.
	 * Valid properties are: width, height, and master.
	 *
	 * @param
	 *        array new properties
	 * @return boolean
	...
	/**
	 * Sharpen and image.
	 * Valid amounts are 1 to 100.
	 *
	 * @param
	 *        integer amount to sharpen
	 * @return boolean
	 */
