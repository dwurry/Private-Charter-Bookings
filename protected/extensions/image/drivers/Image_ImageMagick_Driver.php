...
class Image_ImageMagick_Driver extends Image_Driver{
	...
	public function __construct($config){
		if(empty($config['directory'])){
			...
			if(!is_file($path = exec('which convert'))) throw new CException('image imagemagick not_found');
		...
		if(!is_file(realpath($config['directory']) . '/convert' . $this->ext)) throw new CException('image imagemagick not_found');
