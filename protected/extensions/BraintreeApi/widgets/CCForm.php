...
class CCForm extends CWidget{
	 ...
	 *      )
	 */
	public $fields = array('amount','orderId','creditCard'=>array('number','cvv','month','year','date','name'),'customer'=>array('firstName','lastName','company','phone','fax','website','email'),'billing'=>array('firstName','lastName','company','streetAddress','extendedAddress','locality','region','postalCode','countryCodeAlpha2'),'shipping'=>array('firstName','lastName','company','streetAddress','extendedAddress','locality','region','postalCode','countryCodeAlpha2'));
	private $fields_options = array('creditCard'=>array('number','cvv','month','year'));
	public function init(){
		...
		if(isset($this->type)){
			if($this->type == 'customer'){
				...
				$this->fields_options = array('creditCard'=>array('number','month','year','name'),'billing'=>array('firstName','lastName','company','streetAddress','extendedAddress','locality','region','postalCode','countryCodeAlpha2'));
