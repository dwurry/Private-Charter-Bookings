...
class Braintree_Customer extends Braintree{
	public static function all(){
		...
		$pager = array('className'=>__CLASS__,'classMethod'=>'fetch','methodArgs'=>array(array()));
	...
	public static function createFromTransparentRedirect($queryString){
		...
		return self::_doCreate('/customers/all/confirm_transparent_redirect_request', array('id'=>$params['id']));
	}
	...
	public static function createSignature(){
		...
		$signature = array('id','company','email','fax','firstName','lastName','phone','website',array('creditCard'=>$creditCardSignature),array('customFields'=>array('_anyKey_')));
		return $signature;
	}
	...
	public static function update($customerId, $attributes){
		...
		self::_validateId($customerId);
		return self::_doUpdate('put', '/customers/' . $customerId, array('customer'=>$attributes));
	}
	...
	public static function updateFromTransparentRedirect($queryString){
		trigger_error("DEPRECATED: Please use Braintree_TransparentRedirectRequest::confirm", E_USER_NOTICE);
		$params = Braintree_TransparentRedirect::parseAndValidateQueryString($queryString);
		return self::_doUpdate('post', '/customers/all/confirm_transparent_redirect_request', array('id'=>$params['id']));
	}
	 ...
	 */
	protected $_attributes = array('addresses'=>'','company'=>'','creditCards'=>'','email'=>'','fax'=>'','firstName'=>'','id'=>'','lastName'=>'','phone'=>'','createdAt'=>'','updatedAt'=>'','website'=>'');
	...
	private static function _validateId($id = null){
		if(empty($id)){throw new InvalidArgumentException('expected customer id to be set');}
		if(!preg_match('/^[0-9A-Za-z_-]+$/', $id)){throw new InvalidArgumentException($id . ' is an invalid customer id.');}
	}
