...
class Braintree_TransparentRedirect{
	...
	public static function transactionData($params){
		...
		if($transactionType != Braintree_Transaction::SALE && $transactionType != Braintree_Transaction::CREDIT){throw new InvalidArgumentException('expected transaction[type] of sale or credit, was: ' . $transactionType);}
	...
	public static function updateCreditCardData($params){
		...
		if(!isset($params['paymentMethodToken'])){throw new InvalidArgumentException('expected params to contain paymentMethodToken.');}
	...
	public static function updateCustomerData($params){
		...
		if(!isset($params['customerId'])){throw new InvalidArgumentException('expected params to contain customerId of customer to update');}
	...
	private static function _data($params){
		if(!isset($params['redirectUrl'])){throw new InvalidArgumentException('expected params to contain redirectUrl');}
