...
class Braintree_Util{
	...
	public static function extractAttributeAsArray(& $attribArray, $attributeName){
		if(!isset($attribArray[$attributeName])):return array();
	...
	public static function cleanClassName($name){
		$classNamesToResponseKeys = array('CreditCard'=>'creditCard','Customer'=>'customer','Subscription'=>'subscription','Transaction'=>'transaction','CreditCardVerification'=>'verification','AddOn'=>'addOn','Discount'=>'discount','Plan'=>'plan','Address'=>'address','SettlementBatchSummary'=>'settlementBatchSummary');
	...
	public static function buildClassName($name){
		$responseKeysToClassNames = array('creditCard'=>'CreditCard','customer'=>'Customer','subscription'=>'Subscription','transaction'=>'Transaction','verification'=>'CreditCardVerification','addOn'=>'AddOn','discount'=>'Discount','plan'=>'Plan','address'=>'Address','settlementBatchSummary'=>'SettlementBatchSummary');
