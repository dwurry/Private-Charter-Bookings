...
class Braintree_WebhookNotification extends Braintree{
	...
	private static function _matchingSignature($signaturePairs){
		foreach($signaturePairs as $pair){
			...
			if($components[0] == Braintree_Configuration::publicKey()){return $components[1];}
		}
	...
	private static function _validateSignature($signature, $payload){
		...
		if(!Braintree_Digest::secureCompare($matchingSignature, $payloadSignature)){throw new Braintree_Exception_InvalidSignature("webhook notification signature invalid");}
	}
