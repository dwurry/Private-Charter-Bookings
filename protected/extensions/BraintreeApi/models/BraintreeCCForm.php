...
class BraintreeCCForm extends CFormModel{
	...
	public function rules(){
		return array(array('customerId','required','on'=>'creditcard'),array('customerId','required','on'=>'address'),array('customer_firstName, customer_lastName','required','on'=>'customer'),array('amount','required','on'=>'charge'),array('amount','numerical'),array('customer_email','email'),array('creditCard_number, creditCard_cvv, creditCard_month, creditCard_year, creditCard_date,
                    customer_firstName,
                    customer_lastName,
                    customer_company,
                    customer_phone,
	...
	public function attributeLabels(){
		return array('amount'=>'Amount($)','orderId'=>'Order ID','creditCard_number'=>'Credit Card Number','creditCard_cvv'=>'Security Code','creditCard_month'=>'Expiration Month (MM)','creditCard_year'=>'Expiration Year (YYYY)','creditCard_date'=>'Expiration Date (MM/YYYY)','creditCard_name'=>'Name on Card','customer_firstName'=>'First Name','customer_lastName'=>'Last Name','customer_company'=>'Company Name','customer_phone'=>'Phone Number','customer_fax'=>'Fax Number','customer_website'=>'Website','customer_email'=>'Email','billing_firstName'=>'First Name','billing_lastName'=>'Last Name','billing_company'=>'Company Name','billing_streetAddress'=>'Address','billing_extendedAddress'=>'Address','billing_locality'=>'City/Locality','billing_region'=>'State/Region','billing_postalCode'=>'Zip/Postal Code','billing_countryCodeAlpha2'=>'Country','shipping_firstName'=>'First Name','shipping_lastName'=>'Last Name','shipping_company'=>'Company Name','shipping_streetAddress'=>'Address','shipping_extendedAddress'=>'Address','shipping_locality'=>'City/Locality','shipping_region'=>'State/Region','shipping_postalCode'=>'Zip/Postal Code','shipping_countryCodeAlpha2'=>'Country');
	}
