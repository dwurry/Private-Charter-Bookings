...
class BraintreeApi{
	...
	public function __construct(){
		...
		Braintree_Configuration::clientsideKey($this->clientside_key);
	}
	 ...
	 *        Credit Card Number
	 * @param integer $cvv
	 *        (optional)Credit Card Security code
	 * @param integer $expirationMonth
	 *        format: MM (use expirationMonth and expirationYear or expirationDate not both)
	 * @param integer $expirationYear
	 *        format: YYYY (use expirationMonth and expirationYear or expirationDate not both)
	 * @param string $expirationDate
	 *        format: MM/YYYY (use expirationMonth and expirationYear or expirationDate not both)
	...
	public function getCreditCard($input_values){
		$default = array('cvv'=>null,'month'=>null,'year'=>null,'date'=>null,'name'=>null);
