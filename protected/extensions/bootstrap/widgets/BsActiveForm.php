...
class BsActiveForm extends CActiveForm{
	...
	public function error($model, $attribute, $htmlOptions = array(), $enableAjaxValidation = true, $enableClientValidation = true){
		...
		if(!$enableAjaxValidation && !$enableClientValidation){return BsHtml::error($model, $attribute, $htmlOptions);}
		$id = CHtml::activeId($model, $attribute);
		$inputID = BsArray::getValue('inputID', $htmlOptions, $id);
		unset($htmlOptions['inputID']);
		BsArray::defaultValue('id', $inputID . '_em_', $htmlOptions);
		$option = array('id'=>$id,'inputID'=>$inputID,'errorID'=>$htmlOptions['id'],'model'=>get_class($model),'name'=>$attribute,'enableAjaxValidation'=>$enableAjaxValidation,'inputContainer'=>'div.form-group',		// Bootstrap requires this,
		'errorCssClass'=>$this->errorMessageCssClass,'successCssClass'=>$this->successMessageCssClass);
	...
	public function errorSummary($models, $header = null, $footer = null, $htmlOptions = array()){
		if(!$this->enableAjaxValidation && !$this->enableClientValidation){return BsHtml::errorSummary($models, $header, $footer, $htmlOptions);}
