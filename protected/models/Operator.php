...
class Operator extends CActiveRecord{
	...
	public function rules(){
		...
		return array(array('name, street, city, state, country, zip, phone, email, year_est, fleet, full_time_pilots, part_time_pilots, certificate, where_licensed, operated_by, website, source_url','required'),array('year_est, fleet, full_time_pilots, part_time_pilots','numerical','integerOnly'=>true),array('name, street, email, certificate, where_licensed, operated_by, website','length','max'=>100),array('city, country, phone','length','max'=>50),array('state','length','max'=>2),array('designator','length','max'=>4),array('zip','length','max'=>10),array('source_url','length','max'=>300),
